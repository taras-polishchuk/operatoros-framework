...
export async function initCommand(opts: InitOptions): Promise<void> {
  ...
  console.log("    $ operatoros apply                 # installs journal + timer (already in the binary)");
  console.log("    $ operatoros run journal add 'first entry'");
  console.log("    $ operatoros run timer start 'deep work' 50");
  console.log("");
  console.log("  examples are bundled inside the binary — no separate repo clone needed.");
  console.log("  write your own module: see https://github.com/taras-polishchuk/operatoros-framework/tree/main/examples");
}

function renderManifest(preset: string): string {
  return `# operatoros.yaml — workspace manifest
# generated by operatoros-core v0.5.2-alpha
version: "0.2"
...
operatoros_version: "0.5.2-alpha"
`;
}